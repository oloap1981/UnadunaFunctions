...
public class EsitoHelper {
	...
	public static final int ESITO_KO_CODICE_ERRORE_SALVA_IMMAGINE= 600;
	...
	public static final String ESITO_KO_MESSAGGIO_ERRORE_SALVA_IMMAGINE = "Errore nel salvataggio dell'immagine: ";
}
