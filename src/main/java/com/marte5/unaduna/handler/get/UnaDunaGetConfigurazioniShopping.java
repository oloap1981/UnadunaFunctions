...
public class UnaDunaGetConfigurazioniShopping implements RequestHandler<RichiestaGetGenerica, RispostaGetGenerica> {
    		...
    		if(client != null) {
    			...
    			for (Configurazione configurazione : configurazioni) {
    				if(configurazione.getTipo() != null) {
    					if(configurazione.getTipo().equals(Configurazione.CONFIGURAZIONE_TIPO_SHOPPING)) {
